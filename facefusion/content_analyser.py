...
PROBABILITY_LIMIT = 1.0  # Umbral de probabilidad tan alto que nunca se considerará NSFW
RATE_LIMIT = 1000  # Umbral de tasa de frames NSFW tan alto que nunca se considerará NSFW
STREAM_COUNTER = 0  # No cambia, pero asegúrate de no analizar todos los frames para no sobrecargar el sistema
